<?php
require_once 'admin/publicaciones.php';

$pub = new Publicaciones();
$publicaciones = $pub->get(3);
?>
    ...
    <div class="row">
      ...
      foreach ($publicaciones as $publicacion) { ?>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="item-description.php?id=<?= $publicacion['id'] ?>"><img class="card-img-top" src="<?= $publicacion['url_img'] ?>" alt=""></a>
            <div class="card-body">
              <h4 class="card-title">
                <a href="item-description.php?id=<?= $publicacion['id'] ?>"><?= $publicacion['titulo'] ?></a>
              </h4>
              <p class="card-text"><?= substr($publicacion['descripcion'], 0, 250); ?>...</p>
            </div>
          </div>
        </div>
